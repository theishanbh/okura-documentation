...
const SideBar = () => {
  return (
    <div className="flex min-w-48 border-r border-gray-custom-primary">
      <div className="pt-4 pl-4 flex flex-col gap-8">
        {/* name */}
        <div className="flex items-center gap-2">
          <div className="w-8 h-8 relative rounded-full bg-blue-custom-primary border border-blue-custom-secondary flex items-center justify-center">
