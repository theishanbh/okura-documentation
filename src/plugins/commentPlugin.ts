import { HyperlinkToolTip } from "roosterjs";
 ...
 */
export class CommentPlugin implements EditorPlugin {
   ...
   */
  constructor(
    private showCommentPopup = false,
  ...
  private runWithHyperlink(
    node: Node,
    callback: (href: string, a: HTMLAnchorElement) => void
  ) {
